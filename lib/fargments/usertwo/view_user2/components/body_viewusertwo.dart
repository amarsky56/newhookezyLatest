        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //UserStoriesTwo(),
              UserStories(storyList: userProfileData.stories,showAdd: true,),
              //Home(),
              SizedBox(
                height: 16,
              ),
  ...
  Widget showGrid(){
    if(userProfileData.photos.length > 0){
      return GridView.builder(
          ...
          itemCount: userProfileData.photos.length + 1,
          itemBuilder: (context,index){
            ...
            return GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => PView(photos: userProfileData.photos,index: index - 1,)));
              },
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(color: Colors.black),
                ...
                margin: new EdgeInsets.all(3.0),
                child: SSNetWorkImage(height: 80,width: MediaQuery.of(context).size.width * 0.50,url: userProfileData.photos[index - 1].media,),
              ),
            );
            return index == 0 ? PostAddButton(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => PView(photos: userProfileData.photos,index: index,)));
              },
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(color: Colors.black),
