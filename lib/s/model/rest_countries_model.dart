...
//
//     final restCountriesModel = restCountriesModelFromJson(jsonString);

import 'dart:convert';

List<RestCountriesModel> restCountriesModelFromJson(String str) => List<RestCountriesModel>.from(json.decode(str).map((x) => RestCountriesModel.fromJson(x)));

String restCountriesModelToJson(List<RestCountriesModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RestCountriesModel {
  ...
  factory RestCountriesModel.fromJson(Map<String, dynamic> json) => RestCountriesModel(
    name: json["name"],
